                                            ...
                                            @foreach ($dataType->browseRows as $row)
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($row->type == 'text')
                                                        ...
                                                        {{-- @contr: limit text length  --}}
                                                        <div>
                                                            {{ mb_strlen($data->{$row->field}) > 30 ? mb_substr($data->{$row->field}, 0, 30) . ' ...' : $data->{$row->field} }}
                                                        </div>
                                                    ...
                                                    @elseif($row->type == 'file' && !empty($data->{$row->field}))
                                                        ...
                                                        @endif
                                                        {{-- @contr: limit rich_text_box height --}}
                                                    @elseif($row->type == 'rich_text_box')
                                                        @include('voyager::multilingual.input-hidden-bread-browse')
                                                        <div>
                                                            {{ mb_strlen(strip_tags($data->{$row->field}, '<b><i><u>')) > 30 ? mb_substr(strip_tags($data->{$row->field}, '<b><i><u>'), 0, 30) . ' ...' : strip_tags($data->{$row->field}, '<b><i><u>') }}
                                                        </div>
