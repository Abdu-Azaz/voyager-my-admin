    ...
    <div class="">
        <form action="{{ route('voyager.login') }}" method="POST" class="p-5">
            ...
            <div class="form-group form-group-default my-4" id="emailGroup">
                <label class="fs-4">{{ __('voyager::generic.email') }}</label>
                <div class="controls">
            ...
            <div class="form-group form-group-default my-4" id="passwordGroup">
                <label class="fs-4">{{ __('voyager::generic.password') }}</label>
                <div class="controls">
            ...
            <div class="form-group my-4" id="rememberMeGroup">
                <div class="controls">
                    <input type="checkbox" name="remember" id="remember" value="1"><label class="m-2 fs-4" for="remember"
